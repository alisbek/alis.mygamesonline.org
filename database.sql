...
CREATE TABLE IF NOT EXISTS `orders` (
    ...
    `delivery_method` ENUM('pickup','courier','post','inpost') NOT NULL,
    ...
    `inpost_point_id` VARCHAR(50) DEFAULT NULL,
    `inpost_point_name` VARCHAR(200) DEFAULT NULL,
    `inpost_shipment_id` VARCHAR(100) DEFAULT NULL,
    `inpost_tracking_number` VARCHAR(100) DEFAULT NULL,
    `inpost_status` VARCHAR(50) DEFAULT NULL,
    `notes` TEXT,
